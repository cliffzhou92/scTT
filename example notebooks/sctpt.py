...
def dynamical_analysis(sc_object,sc_object_aggr, n_states = None, n_states_seq = None, weight_connectivities=0.2, n_components=20, thresh_ms_gene = 0):
...
def dynamical_iteration(adata, n_states = None, n_states_seq = None, n_iter = 10, return_aggr_obj=False, weight_connectivities=0.2, n_components=20, n_neighbors = 100,thresh_ms_gene = 0, thresh_entropy = 0.1):
    adata.uns['da_out']={}
    ...
    for i in range(n_iter):
        ...
        dynamical_analysis(adata, sc_object_aggr, n_states = n_states,n_states_seq=n_states_seq, weight_connectivities=weight_connectivities, n_components = n_components,thresh_ms_gene = thresh_ms_gene)
...
def plot_tensor_single(adata, adata_aggr = None, state = 'spliced', attractor = None, basis = 'umap', color ='attractor', color_map = None, size = 20, alpha = 0.5, ax = None, show = None, filter_cells = False, member_thresh = 0.05):
...
def plot_tensor(adata, adata_aggr, list_state =['joint','spliced','unspliced'], list_attractor ='all', basis = 'umap',figsize = (8,8),hspace = 0.2,wspace = 0.2, color_map = None,size = 20,alpha = 0.5, filter_cells = False, member_thresh = 0.05):
    ...
    for state in list_state:
        for attractor in list_attractor:
            ...
            fig_id+=1
            plot_tensor_single(adata, adata_aggr, attractor = attractor, state = state, basis = basis_plot,ax = ax,show = False, member_thresh = member_thresh, filter_cells = filter_cells) 
